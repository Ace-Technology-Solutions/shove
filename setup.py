...
setup(
    ...
    description='''Simple extremely easy to use common object storage frontend''',
    long_description=open('README.rst').read(),
    author='L. C. Rees and javaarchive',
    author_email='removed@noreply.com',
    url='https://github.com/Ace-Technology-Solutions/shove',
    license='BSD',
    packages=find_packages(),
    test_suite='shove.tests',
    install_requires=['futures', 'stuf>=0.8.19'],
    zip_safe=False,
    keywords='object storage persistence database shelve shove',
    classifiers=[
